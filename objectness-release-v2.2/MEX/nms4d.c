...
{
    double *score,*xmin,*ymin,*xmax,*ymax,*scoreLocalMaxim, score_mi_mj_mk_ml = 0,score_i2_j2_k2_l2 = 0;
    int    width,height,M, n, numberMaximLocalMaxim, i,j,k,l,mi,mj,mk,ml,i2,j2,k2,l2, LocalMaxim = 0, currLocalMaxim = -1;
